...
function scene:createScene(event)
	...
	background = display.newImage("img/background1.png",display.contentWidth/2,display.contentHeight/2);background.yScale=1.1
	stage = display.newImage("img/scenario1.png",display.contentWidth/2+78,display.contentHeight/2+15);stage.yScale=.93
...
function scene:enterScene(event)
	...
	local function wavesEtimer()
		local win =  function() storyboard.gotoScene("victoryST2") end
	...
	local spawnZombie = function()
		...
		local removePokeZombie = function()
			storyboard.gotoScene("defeatedST2")
		end
