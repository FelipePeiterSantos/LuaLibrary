...
function scene:createScene(event)
	...
	voceVenceu = display.newText( "VOCÊ VENCEU O PRIMEIRO ESTÁDIO!!!", display.contentWidth/2,0, native.systemFont, 40);voceVenceu.alpha=0
...
function scene:exitScene(event)
	...
	storyboard.purgeScene("victoryST1")
end
